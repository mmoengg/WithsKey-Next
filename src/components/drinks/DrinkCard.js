...
export default function DrinkCard({ image, name, tags, level }) {
    return (
        <li className="p-6 bg-white rounded-2xl shadow-lg flex flex-col items-center relative min-w-[calc(100%/4-25px)] min-h-[380px]">
            {/* 찜(하트) 아이콘 */}
